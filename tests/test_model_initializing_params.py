...
def test_mesh_preprocessing_options_validate_without_importing_blender():
    ...
    assert params.convex_hull_target_faces == 500 and params.preview_max_triangles == 300_000
    assert "preview_remesher" not in params.model_dump()
    for invalid in (dict(convex_hull_target_faces=2_000_001), dict(preview_max_triangles=300_001), dict(preview_max_triangles=120_000),
